...
LOOP     EQU   *                                                        00410000
         ...
         BAS   R8,DATAVAL                  THIS WILL TEST DATA IN       00430083
...
SETUP    EQU   *                       NAME OF FIRST SUBROUTINE!        00670045
         MVC   NUMBA,DATAINA                                            00680099
         MVC   NUMBB,DATAINB                                            00690099
...
JUMPX    EQU   *                                                        01250085
         ...
         BNH   JUMPO                   THIS JUMPS OUT     >4 HERE       01270099
